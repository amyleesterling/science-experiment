...
const ROWS: Row[] = [
  {
    key: "neurons",
    label: "Neurons",
    mouse: { value: 70e6, display: "70 million", anchor: "≈ 8 ft deep on Fenway's field (as baseballs)" },
    human: { value: 86e9, display: "86 billion", anchor: "≈ 2 miles high on the field (as baseballs)" },
    ratio: "~1,200× more",
  },
  {
    key: "synapses",
